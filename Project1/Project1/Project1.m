...
% Last Modified by GUIDE v2.5 30-Dec-2019 11:44:03
...
% handles    structure with handles and user data (see GUIDATA)
for i = 1:8
    filename = [num2str(i-1),'.txt'];
    if (exist( filename,'file')== 0 )
        break;
    end
    Varyname=['Array',num2str(i-1)];
    eval([Varyname,'=importdata(filename);']);
    switch i
        case 1
            axes(handles.axes1);
            plot(Array0);
            handles.Array0 =Array0 ;
            guidata(hObject,handles);
        case 2
            axes(handles.axes2);
            plot(Array1);
            handles.Array1 =Array1 ;
            guidata(hObject,handles);
        case 3
            axes(handles.axes3);
            plot(Array2);
            handles.Array2 = Array2 ;
            guidata(hObject,handles);
        case 4
            axes(handles.axes4);
            plot(Array3);
            handles.Array3 = Array3 ;
            guidata(hObject,handles);
        case 5
            axes(handles.axes5);
            plot(Array4);
            handles.Array4 = Array4 ;
            guidata(hObject,handles);
        case 6
            axes(handles.axes6);
            plot(Array5);
            handles.Array5 = Array5 ;
            guidata(hObject,handles);
        case 7
            axes(handles.axes7);
            plot(Array6);
            handles.Array6 =Array6 ;
            guidata(hObject,handles);
        case 8
            axes(handles.axes8);
            plot(Array7);
            handles.Array7 =Array7 ;
            guidata(hObject,handles);
    end
end
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Array0  = handles.Array0;
[M,N] = size(Array0);
fs = 100; %采样率
n=0:N-1;
Array0_FFT = fft(Array0,N);
m=abs(Array0_FFT);
f=n*fs/N;
axes(handles.axes3);
plot(f,m);
